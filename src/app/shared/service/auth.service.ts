...
/*
 ...
 This tells Angular to provide the service in the application root module.
  @Injectable({
   providedIn: 'root'
 })
*/
...
/*
 Communicating with backend services using HTTP:
  ...
  symbols that appear in the example snippets.

 Requesting data from a server: Use the HTTPClient.get() method to fetch data from a server.
...
/* Always subscribe HttpClient methods!
 ...
 The AsyncPipe subscribes (and unsubscribes) for you automatically. All observables returned from HttpClient methods are cold by design.
 Execution of the HTTP request is deferred, allowing you to extend the observable with additional operations such as
 tap and catchError before anything actually happens.
